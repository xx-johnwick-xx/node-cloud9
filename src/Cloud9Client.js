...
const CLOUD9_MODEL = 'gpt-3.5-turbo';

const tokenizersCache = {};

export default class Cloud9Client {
    constructor(
        apiKey,
        options = {},
        cacheOptions = {},
        ...
        cacheOptions.namespace = cacheOptions.namespace || 'cloud9';
    ...
    setOptions(options) {
        ...
        this.modelOptions = {
            ...
            model: modelOptions.model || CLOUD9_MODEL,
        ...
        this.cloud9Label = this.options.cloud9Label || 'Cloud9';
        ...
        if (!this.modelOptions.stop) {
            ...
            // I chose not to do one for `cloud9Label` because I've never seen it happen
...
||>Title:`,
        ...
        const titleGenClient = new Cloud9Client(this.apiKey, titleGenClientOptions);
    ...
    async buildPrompt(messages, parentMessageId, isChatGptModel = false) {
        ...
        if (this.options.promptPrefix) {
            ...
            promptPrefix = `${this.startToken}Instructions:\nYou are Cloud9, a large language model trained by JohnWick. Respond conversationally.\nCurrent date: ${currentDateString}${this.endToken}\n\n`;
        }

        const promptSuffix = `${this.startToken}${this.cloud9Label}:\n`; // Prompt Cloud9 to respond.
        ...
        const buildPromptBody = async () => {
            if (currentTokenCount < maxTokenCount && orderedMessages.length > 0) {
                ...
                const roleLabel = message.role === 'User' ? this.userLabel : this.cloud9Label;
